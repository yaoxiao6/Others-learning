...
public class BattleshipGame {
    ...
    /*
     * initialize - configures the state of the game, based on the type of game
    ...
    public void initialize(Scanner console) {
        ...
        do {
            ...
            if (choice == 1) {
                ...
                this.players[1] = new Player("the computer"); // change to ComputerPlayer
                ...
                this.boards[0] = new Board(DIMENSION);
                this.players[0] = new Player("player 0"); // change to ComputerPlayer

                // second computer player
                this.boards[1] = new Board(DIMENSION);
                this.players[1] = new Player("player 1"); // change to ComputerPlayer
    ...
    /*
     * addShipsTo - add a fleet of ships to the specified player and board. Note
     * that this method can be static, because it doesn't need to access any of the
     * fields of the BattleshipGame object.
     */
    ...
    /*
     * addShipTo - add a single ship to the specified player and board. Note that
     * this method can be static, because it doesn't need to access any of the
     * fields of the BattleshipGame object.
     */
    ...
    /*
     * processOneGuess - processes a single guess from the player whose index is
     * specified by the second parameter. The index of the other player is given by
     * the third parameter.
     * 
