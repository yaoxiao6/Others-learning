...
public class LinkedTree {
    ...
    public void insert(int key, Object data) {
        ...
        // Insert the new node.
        Node newNode = new Node(key, data, parent);
    ...
    private void deleteNode(Node toDelete, Node parent) {
        if (toDelete.left != null && toDelete.right != null) {
            ...
            toDelete.parent = replace.parent;
    ...
    private class PostorderIterator implements LinkedTreeIterator {
        private Node previousNode; // space O(1)
        ...
        private PostorderIterator() {
            ...
            previousNode = trav;
            System.out.println("Tell me this of postorder: " + previousNode.key);
        }

        public boolean hasNext() { // require O(1), not loop
            return (previousNode != null);
        }

        public int next() {
            int returnKey = previousNode.key;
            if (previousNode == null) {
                throw new NoSuchElementException();
            }
            if (previousNode.parent == null) {
                previousNode = null;
            } else if (previousNode.parent != null && previousNode.parent.left == previousNode
                    && previousNode.parent.right == null) { // if I am at the left, and right is empty, and I am not
                                                            // root
                previousNode = previousNode.parent;
            } else if (previousNode.parent != null && previousNode.parent.right == previousNode) {// if I am at the
                                                                                                  // right, and I am not
                                                                                                  // root
                previousNode = previousNode.parent;
            } else { // I am at left, and right has not been scanned.
                Node trav = previousNode.parent.right;
                while (true) {
                    if (trav.left != null) {
                        trav = trav.left;
                        continue;
